...
export default function UIUX() {
  ...
  return (
    <div className="bg-[#171717] min-h-screen text-white font-valve selection:bg-purple-500 selection:text-white relative">
      <style>{`
        /* 
           Force normal blend mode and high opacity for the bright pattern 
           to ensure it is visible against the dark background.
        */
        .bright-grid-svg path, .bright-grid-svg rect {
        ...
        /* 
           Ensure dim pattern acts as a texture overlay with normal blend mode
           so it doesn't disappear into the black background.
        */
      ...
      {/* --- BACKGROUND SVG LAYERS (Fixed to Viewport, Both Masked) --- */}
      <div 
        ref={containerRef}
      ...
      >
          ...
          <div 
              ...
              style={{
                  maskImage: 'radial-gradient(var(--mask-size) circle at var(--mask-x) var(--mask-y), black 50%, transparent 100%)',
                  WebkitMaskImage: 'radial-gradient(var(--mask-size) circle at var(--mask-x) var(--mask-y), black 50%, transparent 100%)',
              }}
          >
               {/* Layer 1: Highlight Grid (Switched to Bottom) */}
               <div className="absolute inset-0 w-full h-full">
                    <GridPatternBright className="w-full h-full bright-grid-svg" />
               </div>

               {/* Layer 2: Dim Grid (Switched to Top) */}
               <div className="absolute inset-0 w-full h-full">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
                    ...
                    <div className="lg:col-span-8">
                        <p className="text-xl md:text-3xl text-gray-300 leading-relaxed">
                            ...
                            career is rooted in software development, my passion for visuals
                            drives me to make everything I touch look exceptional. I apply my
                            design principles to every aspect of my work—from web and mobile
                            interfaces to designing professional branding assets.
                        </p>
                        <p className="mt-8 text-xl md:text-3xl text-gray-300 leading-relaxed">
                            I view every blank screen as a canvas. Whether it’s a functional dashboard for a client or a simple layout for a personal project, I strive to create visuals that communicate clearly and leave a lasting impression.
                        </p>
                    </div>
                </div>
                </div>
