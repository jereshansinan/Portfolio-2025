...
export const PROJECTS: Project[] = [
  {
    ...
    description:
      "An interactive web application demonstrating various graph theory algorithms including A*, Dijkstra, and BFS in real-time.",
  ...
  },
  {
    ...
    description:
      "A cross-platform mobile application built with React Native helping users track their carbon footprint and suggest eco-friendly habits.",
  ...
  },
  {
    ...
    description:
      "A decentralized file storage system using IPFS protocol simulation for secure and redundant data management.",
  ...
  },
  {
    ...
    description:
      "Implementation of a multi-layer perceptron in C++ without external ML libraries to recognize handwritten digits (MNIST).",
...
export const SOCIALS: SocialLink[] = [
  ...
  {
    platform: "Behance",
    url: "https://www.behance.net/jereshansinan",
    icon: Dribbble,
  },
];
